const en = {
    appHeader: {
      ...
      logout: "Logout",
      federationManagement: "Site Management"
    },
    footer: {
      title: "Cloud Resource Access Control",
    ...
    resourceType: {
      ...
      selected: "selected",
      federation: "Site",
      selectFederation: "Select a site",
      federationRequired: "Site is required"
    },
    userManagement: {
      ...
      federationAdministrator: "Site Administrator",
    },
    resourceForm: {
    ...
    federations: {
      ...
      addFederation: "Add Site",
      editFederation: "Edit Site",
      newFederation: "New Site",
      name: "Site Name",
      description: "Description",
      searchFederations: "Search sites...",
      noFederationsFound: "No sites found.",
      federationUpdatedSuccess: "Site '{{name}}' updated successfully",
      federationCreatedSuccess: "Site '{{name}}' created successfully",
      federationDeletedSuccess: "Site '{{name}}' deleted successfully",
      unableToUpdateFederation: "Unable to update site '{{name}}'",
      unableToCreateFederation: "Unable to create site '{{name}}'",
      unableToDeleteFederation: "Unable to delete site '{[name]}'",
      confirmDeleteFederation: "Are you sure you want to delete the site '{{name}}'? All associated resources and resource types will also be deleted.",
      members: "{{count}} members",
      admins: "Administrators",
      unableToLoadFederations: "Unable to load sites",
      ...
      noMembersInFederation: "No members in this site.",
      noAdminsInFederation: "No administrators in this site.",
      ...
      confirmRemoveUser: "Are you sure you want to remove user '{{name}}' from site '{{federation}}'?",
